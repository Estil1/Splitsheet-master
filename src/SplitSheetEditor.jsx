      ...
      <div className="p-6 max-w-5xl mx-auto bg-white text-black transition-colors duration-300">
        ...
        >
          ...
          <div className="flex justify-center mb-4">
            {logoImage ? (
              <img src={logoImage} alt="Logo" className="h-40 max-w-full object-contain" />
            ) : (
              <div className="flex items-center justify-center h-24 w-full max-w-sm mx-auto bg-gray-100 rounded-md">
          ...
          <div className="mb-10 overflow-x-auto">
            <table className="w-full border-collapse border-gray-300 transition-colors duration-300">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-300 p-3 text-left font-bold">Máster/Composición</th>
                  <th className="border border-gray-300 p-3 text-left font-bold">Propiedad de las Composiciones</th>
                  <th className="border border-gray-300 p-3 text-left font-bold">Créditos</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-3 align-top" rowSpan="1">
          ...
          <div className="mb-8">
            ...
            <ol className="list-decimal pl-8 mb-4 space-y-1 text-gray-700">
          ...
          <div className="mb-8 overflow-x-auto">
            <table className="w-full border-collapse border-gray-300 transition-colors duration-300">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-300 p-3 text-left font-bold">Nombre completo</th>
                  <th className="border border-gray-300 p-3 text-left font-bold">Porcentaje (%)</th>
              ...
              <tbody>
                {formData.colaboradorMaster1 && (
                  <tr className="hover:bg-gray-50">
                    <td className="border border-gray-300 p-3">{formData.colaboradorMaster1}</td>
                    <td className="border border-gray-300 p-3">{formData.porcentajeMaster1 || "0"}%</td>
                    <td className="border border-gray-300 p-3">{formData.rolMaster1 || "[ESPECIFICAR ROL]"}</td>
                  </tr>
                )}
                
                {formData.colaboradorMaster2 && (
                  <tr className="hover:bg-gray-50">
                    <td className="border border-gray-300 p-3">{formData.colaboradorMaster2}</td>
                    <td className="border border-gray-300 p-3">{formData.porcentajeMaster2 || "0"}%</td>
                    <td className="border border-gray-300 p-3">{formData.rolMaster2 || "[ESPECIFICAR ROL]"}</td>
                  </tr>
                )}
                
                {formData.colaboradorMaster3 && (
                  <tr className="hover:bg-gray-50">
                    <td className="border border-gray-300 p-3">{formData.colaboradorMaster3}</td>
                    <td className="border border-gray-300 p-3">{formData.porcentajeMaster3 || "0"}%</td>
                    <td className="border border-gray-300 p-3">{formData.rolMaster3 || "[ESPECIFICAR ROL]"}</td>
                  </tr>
                )}
                
                {formData.colaboradorMaster4 && (
                  <tr className="hover:bg-gray-50">
                    <td className="border border-gray-300 p-3">{formData.colaboradorMaster4}</td>
                    <td className="border border-gray-300 p-3">{formData.porcentajeMaster4 || "0"}%</td>
                    <td className="border border-gray-300 p-3">{formData.rolMaster4 || "[ESPECIFICAR ROL]"}</td>
                  </tr>
                )}
                
                <tr className="font-bold bg-gray-100">
                  <td className="border border-gray-300 p-3">TOTAL</td>
                  <td className="border border-gray-300 p-3">{totalPorcentajeMaster}%</td>
